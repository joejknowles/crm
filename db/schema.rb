...
ActiveRecord::Schema.define(version: 20150614185827) do
  ...
  add_index "quizzes", ["client_id"], name: "index_quizzes_on_client_id", using: :btree
  ...
  add_foreign_key "quizzes", "clients"
  add_foreign_key "sections", "quizzes"
end
